...
public class OrderController {
    ...
    @GetMapping("/catalogue")
          ...
          public String orderproduct(HttpSession session,Model model,@RequestParam("proprice") int proprice,@RequestParam("quantity")int orderdetailqty,@RequestParam("proid") int productid){
            ...
            try{
              ...
              while(resultSet.next()){
                ...
                Date paymentdate = resultSet.getDate("paymentdate");
                  ...
                  orderstaff orderstaffs = new orderstaff(orderid,fullname,custaddress,proname,orderdetailsqty,orderprice,paymentamt,paymentdate,null,null,paymentprf,orderstatus);
